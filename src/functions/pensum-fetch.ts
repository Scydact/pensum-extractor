...
export const LOCAL_STORAGE_PREFIX = import.meta.env.VITE_PENSUM_STORAGE_PENSUM_LOCALSAVE_KEY
export const LOCAL_SERVER_PREFIX = import.meta.env.BASE_URL + 'pensum'
