    ...
    return (
        <GenericModalNavBack
            ...
            footer={
                <>
                    <ButtonGroup>
                        <Button onClick={() => downloadPng(getExportTitle(pensum), items, getPensumFilename(pensum))}>
                            <FaRegFileImage /> Descargar PNG
                        </Button>
                        <Button onClick={() => downloadPdf(getExportTitle(pensum), items, getPensumFilename(pensum))}>
