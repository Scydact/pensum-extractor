...
export default function PensumProgress() {
    ...
    return (
        <Card className="pensum-progress-container">
            ...
            <Card.Body>
                <Row>
                    ...
                    <Col>
                        <Percent n={data.mats.passed} total={data.mats.total} extra={data.mats.course} cl="course" />
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col>
                        <Percent n={data.creds.passed} total={data.creds.total} extra={data.creds.course} cl="course" />
                    </Col>
                </Row>
            </Card.Body>
        </Card>
...
function Percent({ n, total, extra = 0, cl = '' }: PercentProps) {
    ...
    return (
        <div className="pensum-progress-value">
            <div>
                {n}/{total} ({pBase}%)
            </div>
